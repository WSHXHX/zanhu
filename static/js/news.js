$(function () {
    ...
    function getCookie(name) {
        ...
        } else if (document.getElementsByName("csrfmiddlewaretoken") && document.getElementsByName("csrfmiddlewaretoken")[0].value.length) {
    ...
    $("#replyNews").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(`li[news-id='${data.newsId}'] .comment-count`).text(data.comments);
            },
            error: function (data) {
                alert(data.responseText);
            },
